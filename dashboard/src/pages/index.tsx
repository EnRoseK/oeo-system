						...
						<div className='relative mx-auto overflow-hidden h-[36rem] lg:h-[24rem]'>
							...
							>
								...
								<p className='mb-4 text-gray-500 dark:text-gray-400'>
									Get started with a free and open-source admin dashboard layout built with Tailwind
									CSS and Flowbite featuring charts, widgets, CRUD layouts, authentication pages,
									and more
								</p>
								...
								<ul className='pl-4 mb-4 space-y-3 text-gray-500 list-disc dark:text-gray-400'>
									<li>
										What are the new challenges in the delivery industry due to new consumer
										expectations.
									</li>
									<li>
