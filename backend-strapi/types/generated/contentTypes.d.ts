...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    permission: Attribute.JSON & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::users-permissions.user',
...
export interface ApiProductExpenseProductExpense extends Schema.CollectionType {
  ...
  attributes: {
    ...
    paymentType: Attribute.Enumeration<['CARD', 'CASH', 'TRANSFER', 'RENT']> &
      Attribute.Required;
...
export interface ApiProductIncomeProductIncome extends Schema.CollectionType {
  collectionName: 'product_incomes';
  info: {
    singularName: 'product-income';
    pluralName: 'product-incomes';
    displayName: 'ProductIncome';
    description: '';
  };
  options: {
    draftAndPublish: false;
